...
typedef enum {
	/** No error. */
	GSKeychainErrorNone = noErr,
	
	/** Some of the arguments were invalid. */
	GSKeychainErrorBadArguments = -1001,
	
	/** There was no password. */
	GSKeychainErrorNoPassword = -1002,
	
	/** One or more parameters passed internally were not valid. */
	GSKeychainErrorInvalidParameter = errSecParam,
	
	/** Failed to allocate memory. */
	GSKeychainErrorFailedToAllocated = errSecAllocate,
	
	/** No trust results are available. */
	GSKeychainErrorNotAvailable = errSecNotAvailable,
	
	/** Authorization/Authentication failed. */
	GSKeychainErrorAuthorizationFailed = errSecAuthFailed,
	
	/** The item already exists. */
	GSKeychainErrorDuplicatedItem = errSecDuplicateItem,
	
	/** The item cannot be found.*/
	GSKeychainErrorNotFound = errSecItemNotFound,
	
	/** Interaction with the Security Server is not allowed. */
	GSKeychainErrorInteractionNotAllowed = errSecInteractionNotAllowed,
	
	/** Unable to decode the provided data. */
	GSKeychainErrorFailedToDecode = errSecDecode
} GSKeychainErrorCode;

extern NSString *const kGSKeychainErrorDomain;

/** Account name. */
extern NSString *const kGSKeychainAccountKey;
 ...
 */
extern NSString *const kGSKeychainCreatedAtKey;

/** Item class. */
extern NSString *const kGSKeychainClassKey;

/** Item description. */
extern NSString *const kGSKeychainDescriptionKey;

/** Item label. */
extern NSString *const kGSKeychainLabelKey;

/** Time the item was last modified.
 
 The value will be a string.
 */
extern NSString *const kGSKeychainLastModifiedKey;

/** Where the item was created. */
extern NSString *const kGSKeychainWhereKey;
...
/**
 ...
 GSKeychain has since switched to a simpler implementation that was abstracted from [SSToolkit](http://sstoolk.it).
 */
...
/**
 ...
 See the `NSString` constants declared in GSKeychain.h for a list of keys that can be used when accessing the
...
/*
 ...
 //设置token 密钥
 #define __kKeyChainServer__          @"com.laizhuan"
 #define __kKeyChainAccountToken__    @"com.laizhuan.token"
 #define __kKeyChainAccountPassword__ @"com.laizhuan.password"
 
 //取出Keychain：
 [GSKeychain passwordForService:__kKeyChainServer__ account:__kKeyChainAccountToken__];
 
 //设置Keychain：
 [GSKeychain setPassword:messageBean.responseBean.token forService:__kKeyChainServer__ account:__kKeyChainAccountToken__];
 
 //置空Keychain：
 [GSKeychain deletePasswordForService:__kKeyChainServer__ account:__kKeyChainAccountToken__];
 */
