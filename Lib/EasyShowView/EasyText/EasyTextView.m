...
- (void)showViewWithSuperView:(UIView *)superView
{
    ...
    self.showBgView.backgroundColor=[self.showTextConfig.bgColor colorWithAlphaComponent:self.showTextConfig.alphaBG];
...
//    addSubLayer.backgroundColor=[self.showTextConfig.bgColor colorWithAlphaComponent:self.showTextConfig.alphaBG].CGColor;
