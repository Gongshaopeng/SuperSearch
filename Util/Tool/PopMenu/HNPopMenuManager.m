...
- (void)showPopMenuWithView:(UIView *)view items:(NSArray *)itemArr{
    ...
    [UIView animateWithDuration:0.2f animations:^{
        self.popmenuView.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0.3];
...
- (void)dismiss{
    [UIView animateWithDuration:0.2f animations:^{
        ...
        self.popmenuView.tableView.transform = CGAffineTransformMakeScale(0.1, 0.001);
