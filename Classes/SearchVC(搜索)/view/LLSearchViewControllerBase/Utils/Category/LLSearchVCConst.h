...
// Status bar height.
#define  ZYHT_StatusBarHeight     (kScreenHeight == 812.0 ? 40.f : 20.f)

// Navigation bar height.
#define  ZYHT_NavigationBarHeight  (kScreenHeight == 812.0 ? 44.f : 44.f)

// Tabbar height.
#define  ZYHT_TabbarHeight         (kScreenHeight == 812.0 ? 60.f : 49.f)

// Status bar & navigation bar height.
#define  ZYHT_StatusBarAndNavigationBarHeight   (kScreenHeight == 812.0 ? (88.f) : (20.f + 44.f))
